...
<body>
    ...
    <div class="" style="padding:10px;">
        <div class="sidemenu-header">
            ...
            <a href="{{ route('jsonlogout') }}" class="navbar-brand  align-items-end" style="text-algin:right;padding-left:85%;text-decoration:none;color:#A84448;font-weight:900;">logout</a>
    ...
    <div class="main-content d-flex flex-column">
        ...
        <div class="breadcrumb-area" style="background-color:#8DC26F;">
            ...
            <a href="{{ route('tabledataview') }}" style="text-align: end;text-decoration:none;padding-left:70%;font-weight:900;margin:10px 10px;color:#A84448;"><button type="submit" class="#" id="infoid">Users Data</button></a>
            ...
            {{-- <a href="{{ route('indexfile') }}" style="text-align: end;text-decoration:none;padding-left:70%;font-weight:900;margin:10px 10px;color:#A84448;"><button type="submit" class="#" id="infoidd">FileUpload</button></a> --}}
        </div>
        <!-- End Breadcrumb Area -->
...
<form class="row overflow"  method="POST" action="{{ route('jsonpost') }}" style="border-radius:15px; background-color:#8DC26F;" enctype="multipart/form-data">
@csrf    
...
<label class="">{{ $fld_val['label'] }}<span class="span">@if($fld_val['required'] == "true")*@endif</span>:</label>
        ...
        <input type="{{ $fld_val['input_type'] }}" name="{{ $fld_val['name'] }}" id="{{ $fld_val['id'] }}"  @if($fld_val['required'] == "true")required @endif  class="form-control copy-input">
        @elseif ($fld_val['input_type'] == "checkbox")
        <div>
            <input type="{{ $fld_val['input_type'] }}" class="copy-check" name="{{ $fld_val['name'] }}" id="{{ $fld_val['id'] }}" {{ $fld_val['action'] }} >    
        </div>
                ...
                <input type="{{ $fld_val['filee_name']['input_type'] }}" id="{{ $fld_val['filee_name']['file_id'] }}" name="{{ $fld_val['filee_name']['file_name'] }}" class="form-control file copy-file">
                </div>
                </div>
                @endif
        @else
        <select name="{{ $fld_val['name'] }}" id="{{ $fld_val['id'] }}" class="form-control copy-select">
       ...
       @endforeach 
        <div style="text-align: end;margin: 10px; padding-top: 10px; border-radius: 5px;">
            <button type="submit" class="btn" style="border-radius: 6px;background-color:#A84448;font-weight:700;text-transform:uppercase;">Submit</button>
        </div>  
</div>
@endforeach   
</form>  
@endif
        ...
        {{-- style="color:#fff;background-color:#3d2e2e;font-weight:700;" --}}
    ...
    <footer class="footer-area" style="background-color:#8DC26F;">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 text-right">
                <p style="padding-right:50px;">Designed by ❤️ <a href="https://envytheme.com/" target="_blank">EnvyTheme</a></p>
            </div>
        </div>
    </footer>
    <!-- End Footer End -->
